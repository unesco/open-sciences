 ...
 * @endcode
 */
$settings['hash_salt'] = 'c-E5CCLnF4p1vh24XGvwJY7zuFV5S1gAWW2o_SID1mN3hQPT-XjwuP1hWBXTKbWkBOyIeHTrHw';
...
$config['search_api.server.open_search']['backend_config']['connector_config']['url'] = getenv('OPENSEARCH_URL');
